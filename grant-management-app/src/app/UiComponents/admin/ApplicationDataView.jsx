          ...
          <Card variant="outlined" sx={{p: {xs: 0, md: 2}, borderRadius: '12px', mt: 2}}>
              <CardContent>
                  ...
                  >
                      ...
                      <Tab label="الملفات الداعمة" icon={<AttachFile/>} iconPosition="start"/>
                                      ...
                                      items={[
                                          {
                                              ...
                                              value: SupportType[scholarshipInfo?.supportType] || 'لا يوجد',
                                          },
                                          {
                            ...
                            <Section title="الأداء الأكاديمي">
                                <InfoList
                                      items={[
                                          {
                                              label: 'نوع الدراسة',
                                              value: StudyType[academicPerformance?.typeOfStudy] || 'لا يوجد',
                                          },
                                          {
                                              label: 'نوع المعدل',
                            ...
                            <Section title="معلومات السكن">
                                <InfoList
                                      items={[
                                          {
                                              label: 'نوع السكن',
                                              value: ResidenceType[residenceInfo?.residenceType] || 'لا يوجد',
                                          },
                                          {
                                              label: 'الدولة',
                                          ...
                                          {
                                              label: 'حالة الأب',
                                              value: ParentStatus[residenceInfo?.fatherStatus] || 'غير متوفر',
                                          },
                                          {
                                              label: 'دخل الأب',
                                          ...
                                          {
                                              label: 'حالة الأم',
                                              value: ParentStatus[residenceInfo?.motherStatus] || 'غير متوفر',
                                          },
                                          {
                                              label: 'دخل الأم',
                                      ...
                                      items={[
                                          {
                                              ...
                                              value: commitment ? (
                                                    <Typography color="success.main">
                                                        <CheckCircle sx={{verticalAlign: 'middle'}}/> تم الموافقة
                                                    </Typography>
                                              ) : (
                                                    <Typography color="error.main">
                                                        <Cancel sx={{verticalAlign: 'middle'}}/> لم يتم الموافقة
                                                    </Typography>
                                              ),
                                          },
                                          {
    ...
    return (
          ...
          >
              <Table>
                  <TableHead>
                      <TableRow>
                          {['الرقم', 'الاسم', 'العلاقة', 'الجامعة', 'الكلية', 'القسم', 'سنة الدراسة', 'مصدر تغطية الدراسة', 'مصدر المنحة', 'قيمة المنحة', 'الوثيقة'].map((header, index) => (
                                <TableCell
                                      key={index}
                                      align="center"
                                      sx={{
                      ...
                      {siblings.length > 0 ? (
                            siblings.map((sibling, index) => (
                                  ...
                                  >
                                      ...
                                      <TableCell align="center">{StudySource[sibling.sourceOfStudy]}</TableCell>
                                      <TableCell align="center">{sibling.grantSource || 'غير متوفر'}</TableCell>
                                      <TableCell align="center">{sibling.grantAmount || 'غير متوفر'}</TableCell>
